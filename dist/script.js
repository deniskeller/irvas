...
window.addEventListener("DOMContentLoaded", function () {
  var state = {};
  var deadline = "2020-09-29";
  Object(_modules_modalState__WEBPACK_IMPORTED_MODULE_4__["default"])(state);
  ...
  form.forEach(function (item) {
    item.addEventListener("submit", function (e) {
      ...
      postData("assets/server.php", formData).then(function (result) {
        ...
        return statusMessage.textContent = message.error;
      }).finally(function () {
        clearInputs();
        setTimeout(function () {
...
var modalState = function modalState(state) {
  var popupForm = document.querySelectorAll(".balcon_icons_img"),
...
/* harmony default export */ __webpack_exports__["default"] = (modalState);
...
var timer = function timer(deadline) {
  ...
  var setClock = function setClock(endtime) {
